    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <p>
          ...
          where I share my work experience and try to help people to learn from my mistakes. It is known for a fact that the fastest and the best way to learn is to learn from someone else's mistakes and experiences. I also share the best practices in software development. Besides writing and spending time with my kids, I also study the finances and entrepreneurship by reading books and listening to various podcasts.
        </p>
      </Layout>
    )
  }
